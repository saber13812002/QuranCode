...
Tools\Replace\bin\Release\Replace.exe NET2 Version.bat 000 1301
Tools\Version\bin\Release\Version.exe .               6.19.1301.4 6.19.1301.4 -Tools
...
COPY QuranCode1433.zip        ..\Backup\QuranCode1433_6.19.1301.zip
COPY QuranCode1433.Source.zip ..\Backup\QuranCode1433_6.19.1301.Source.zip
