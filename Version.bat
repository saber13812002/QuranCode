...
Tools\Replace\bin\Release\Replace.exe NET2 Version.bat 000 1297
Tools\Version\bin\Release\Version.exe .               6.19.1297.4 6.19.1297.4 -Tools
...
COPY QuranCode1433.zip        ..\Backup\QuranCode1433_6.19.1297.zip
COPY QuranCode1433.Source.zip ..\Backup\QuranCode1433_6.19.1297.Source.zip
