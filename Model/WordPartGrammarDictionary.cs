...
namespace Model
{
    ...
    {
        public static string Arabic(string key)
        {
            if (key != null)
            {
                if (s_arabic_dictionary.ContainsKey(key))
                {
                    return s_arabic_dictionary[key];
                }
            }
            return null;
        }
        public static string English(string key)
        {
            if (key != null)
            {
                if (s_english_dictionary.ContainsKey(key))
                {
                    return s_english_dictionary[key];
                }
            }
            return null;
        }
