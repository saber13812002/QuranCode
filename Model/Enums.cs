...
namespace Model
{
    ...
    public enum NumbersResultType
    {
        ...
        WordRanges, VerseRanges, ChapterRanges, PageRanges, StationRanges, PartRanges, GroupRanges, HalfRanges, QuarterRanges, BowingRanges,
        WordSets, VerseSets, ChapterSets, PageSets, StationSets, PartSets, GroupSets, HalfSets, QuarterSets, BowingSets
    };
