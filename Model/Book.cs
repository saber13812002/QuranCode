...
namespace Model
{
    public class Book
    {
        ...
        private void SetupDistancesToPrevious(bool distances_within_chapters)
        {
            ...
            // foreach verse: calculate distance back to previous occurrence
            ...
            // foreach word: calculate distance back to previous occurrence
        ...
        public Dictionary<string, int> GetNextWords(List<Verse> verses, string text, TextLocationInVerse text_location_in_verse, TextLocationInWord text_location_in_word, TextWordness text_wordness)
        {
            Dictionary<string, int> result = new Dictionary<string, int>();
            if (verses != null)
            {
