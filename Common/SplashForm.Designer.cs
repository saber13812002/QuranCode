partial class SplashForm
{
    ...
    private void InitializeComponent()
    {
        ...
        this.VersionLabel.Text = "©2009-2020 Ali Adams";
        this.VersionLabel.TextAlign = System.Drawing.ContentAlignment.TopCenter;
        this.ToolTip.SetToolTip(this.VersionLabel, "©2009-2020 Ali Adams - علي عبد الرزاق عبد الكريم القره غولي");
        // 
        // InitialLettersLabel
        // 
        ...
        this.InitialLettersLabel.Text = "صراط علي حق نمسكه  |  نص حكيم له سر قاطع";
        this.InitialLettersLabel.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
        this.ToolTip.SetToolTip(this.InitialLettersLabel, "The path of Ali is a truth we hold fast to.\r\nA perfect text with a decisive secret.");
