...
public static class Research
{
    ...
    private static string WordNumber_WordValue(Client client, string param, bool in_search_result)
    {
        if (client == null) return null;
        List<Verse> verses = GetSourceVerses(client, in_search_result);
        if (verses != null)
    ...
    private static string LetterNumber_WordValue(Client client, string param, bool in_search_result)
    {
        if (client == null) return null;
        List<Verse> verses = GetSourceVerses(client, in_search_result);
        if (verses != null)
    ...
    private static string LetterNumber_LetterValues(Client client, string param, bool in_search_result)
    {
        if (client == null) return null;
        List<Verse> verses = GetSourceVerses(client, in_search_result);
        if (verses != null)
    ...
    private static string FirstWordFrequency_VerseNumber(Client client, string param, bool in_search_result)
    {
        if (client == null) return null;
        if (client.NumerologySystem == null) return null;
        List<Verse> verses = GetSourceVerses(client, in_search_result);
    ...
    private static string LastWordFrequency_VerseNumber(Client client, string param, bool in_search_result)
    {
        if (client == null) return null;
        if (client.NumerologySystem == null) return null;
        List<Verse> verses = GetSourceVerses(client, in_search_result);
    ...
    public static string P_PivotVersesWithText(Client client, string param, bool in_search_result)
    {
        ...
        if (verses != null)
        {
            return DoP_PivotVersesWithText(client, verses, param);
        }
        return null;
    }
    public static string AP_PivotVersesWithText(Client client, string param, bool in_search_result)
    {
        ...
        if (verses != null)
        {
            return DoAP_PivotVersesWithText(client, verses, param);
        }
        return null;
    }
    public static string XP_PivotVersesWithText(Client client, string param, bool in_search_result)
    {
        ...
        if (verses != null)
        {
            return DoXP_PivotVersesWithText(client, verses, param);
        }
        return null;
    }
    public static string C_PivotVersesWithText(Client client, string param, bool in_search_result)
    {
        ...
        if (verses != null)
        {
            return DoC_PivotVersesWithText(client, verses, param);
        }
        return null;
    }
    public static string AC_PivotVersesWithText(Client client, string param, bool in_search_result)
    {
        ...
        if (verses != null)
        {
            return DoAC_PivotVersesWithText(client, verses, param);
        }
        return null;
    }
    public static string XC_PivotVersesWithText(Client client, string param, bool in_search_result)
    {
        ...
        if (verses != null)
        {
            return DoXC_PivotVersesWithText(client, verses, param);
        }
        return null;
    }
    private static string DoP_PivotVersesWithText(Client client, List<Verse> verses, string param)
    {
        if (client == null) return null;
        if (verses == null) return null;

        StringBuilder str = new StringBuilder();
        str.Append("Pivot" + "\t" + "M" + "\t" + "N" + "\t" + "M*N" + "\t" + "P" + "\t" + "MN+P" + "\t" + "Text" + "\r\n");
        ...
        for (int i = 1; i <= 114; i++)
        {
            ...
            do
            {
                ...
                string verse_text = GetVersesWithText(client, MN_P, param);
                str.Append(i + "\t" + M + "\t" + N + "\t" + MN + "\t" + P + "\t" + MN_P + "\t" + verse_text + "\r\n");
    ...
    private static string DoAP_PivotVersesWithText(Client client, List<Verse> verses, string param)
    {
        if (client == null) return null;
        if (verses == null) return null;

        StringBuilder str = new StringBuilder();
        str.Append("Pivot" + "\t" + "M" + "\t" + "N" + "\t" + "M*N" + "\t" + "AP" + "\t" + "MN+AP" + "\t" + "Text" + "\r\n");
        ...
        for (int i = 1; i <= 114; i++)
        {
            ...
            do
            {
                ...
                string verse_text = GetVersesWithText(client, MN_AP, param);
                str.Append(i + "\t" + M + "\t" + N + "\t" + MN + "\t" + AP + "\t" + MN_AP + "\t" + verse_text + "\r\n");
    ...
    private static string DoXP_PivotVersesWithText(Client client, List<Verse> verses, string param)
    {
        if (client == null) return null;
        if (verses == null) return null;

        StringBuilder str = new StringBuilder();
        str.Append("Pivot" + "\t" + "M" + "\t" + "N" + "\t" + "M*N" + "\t" + "XP" + "\t" + "MN+XP" + "\t" + "Text" + "\r\n");
        ...
        for (int i = 1; i <= 114; i++)
        {
            ...
            do
            {
                ...
                string verse_text = GetVersesWithText(client, MN_XP, param);
                str.Append(i + "\t" + M + "\t" + N + "\t" + MN + "\t" + XP + "\t" + MN_XP + "\t" + verse_text + "\r\n");
    ...
    private static string DoC_PivotVersesWithText(Client client, List<Verse> verses, string param)
    {
        if (client == null) return null;
        if (verses == null) return null;

        StringBuilder str = new StringBuilder();
        str.Append("Pivot" + "\t" + "M" + "\t" + "N" + "\t" + "M*N" + "\t" + "C" + "\t" + "MN+C" + "\t" + "Text" + "\r\n");
        ...
        for (int i = 1; i <= 114; i++)
        {
            ...
            do
            {
                ...
                string verse_text = GetVersesWithText(client, MN_C, param);
                str.Append(i + "\t" + M + "\t" + N + "\t" + MN + "\t" + C + "\t" + MN_C + "\t" + verse_text + "\r\n");
    ...
    private static string DoAC_PivotVersesWithText(Client client, List<Verse> verses, string param)
    {
        if (client == null) return null;
        if (verses == null) return null;

        StringBuilder str = new StringBuilder();
        str.Append("Pivot" + "\t" + "M" + "\t" + "N" + "\t" + "M*N" + "\t" + "AC" + "\t" + "MN+AC" + "\t" + "Text" + "\r\n");
        ...
        for (int i = 1; i <= 114; i++)
        {
            ...
            do
            {
                ...
                string verse_text = GetVersesWithText(client, MN_AC, param);
                str.Append(i + "\t" + M + "\t" + N + "\t" + MN + "\t" + AC + "\t" + MN_AC + "\t" + verse_text + "\r\n");
    ...
    private static string DoXC_PivotVersesWithText(Client client, List<Verse> verses, string param)
    {
        if (client == null) return null;
        if (verses == null) return null;

        StringBuilder str = new StringBuilder();
        str.Append("Pivot" + "\t" + "M" + "\t" + "N" + "\t" + "M*N" + "\t" + "XC" + "\t" + "MN+XC" + "\t" + "Text" + "\r\n");
        ...
        for (int i = 1; i <= 114; i++)
        {
            ...
            do
            {
                ...
                string verse_text = GetVersesWithText(client, MN_XC, param);
                str.Append(i + "\t" + M + "\t" + N + "\t" + MN + "\t" + XC + "\t" + MN_XC + "\t" + verse_text + "\r\n");
    ...
    private static string GetVersesWithText(Client client, long value, string text)
    {
        if (client == null) return null;
        if (client.Book == null) return null;
        if (client.Book.Verses == null) return null;
        ...
        foreach (Verse verse in client.Book.Verses)
        {
            long verse_value = client.CalculateValue(verse);
            if (verse_value == value)
            {
                if (verse.Text.Contains(text))
                {
                    str.Append(verse.Address + "\t" + verse.Text + "\t");
                }
            }
        }
    ...
    private static string GetConsecutiveVerses(Client client, long value1, long value2, bool display_both)
    {
        ...
        if ((value1 > 0) && (value2 > 0))
        {
            ...
            foreach (Verse verse1 in found_verses1)
            {
                ...
                {
                    if (Math.Abs(verse2.Number - verse1.Number) == 1) // consecutive verses
                    {
                        if (display_both)
                        {
                            str.Append(verse1.Text + "\t" + verse2.Text + "\t");
                        }
                        else
                        {
                            str.Append(verse1.Text + "\t");
                        }
                    }
                }
            }
    ...
    private static string N_P_31Verses(Client client, string param, bool in_search_result)
    {
        if (client == null) return null;
    ...
    private static string N_C_31Verses(Client client, string param, bool in_search_result)
    {
        if (client == null) return null;
        if (String.IsNullOrEmpty(param)) return null;
        if (client.Book == null) return null;
    ...
    private static string rN_P_31Verses(Client client, string param, bool in_search_result)
    {
        if (client == null) return null;
        if (String.IsNullOrEmpty(param)) return null;
        if (client.Book == null) return null;
    ...
    private static string rN_C_31Verses(Client client, string param, bool in_search_result)
    {
        if (client == null) return null;
        if (String.IsNullOrEmpty(param)) return null;
        if (client.Book == null) return null;
    ...
    private static string M_P_31Verses(Client client, string param, bool in_search_result)
    {
        if (client == null) return null;
        if (String.IsNullOrEmpty(param)) return null;
        if (client.Book == null) return null;
    ...
    private static string M_C_31Verses(Client client, string param, bool in_search_result)
    {
        if (client == null) return null;
        if (String.IsNullOrEmpty(param)) return null;
        if (client.Book == null) return null;
    ...
    private static string rM_P_31Verses(Client client, string param, bool in_search_result)
    {
        if (client == null) return null;
        if (String.IsNullOrEmpty(param)) return null;
        if (client.Book == null) return null;
    ...
    private static string rM_C_31Verses(Client client, string param, bool in_search_result)
    {
        if (client == null) return null;
        if (String.IsNullOrEmpty(param)) return null;
        if (client.Book == null) return null;
    ...
    private static string N_M_31Verses(Client client, string param, bool in_search_result)
    {
        if (client == null) return null;
        if (String.IsNullOrEmpty(param)) return null;
        if (client.Book == null) return null;
    ...
    private static string N_rM_31Verses(Client client, string param, bool in_search_result)
    {
        if (client == null) return null;
        if (String.IsNullOrEmpty(param)) return null;
        if (client.Book == null) return null;
